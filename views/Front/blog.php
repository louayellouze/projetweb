                            ...
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i class="far fa-user text-primary me-2"></i><?= $row['nom']; ?></small>
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>01 Jan, 2045</small>
                                    </div>
                                    <h4 class="mb-3"><?= $row['titre']; ?></h4>
                                    <p><?= $row['contenu']; ?></p>
                                    <a class="text-uppercase" href="detail.php?id=<?php echo $row["id"] ?>">Read More <i class="bi bi-arrow-right"></i></a>
                                    <?php   if ( $pubC->ChercherUtilisateur($_SESSION['user']) == $row["id_user"]) {  ?>  
                                    <a class="text-uppercase" href="modifierBlog.php?id=<?php echo $row["id"] ?>">Modifier <i class="bi bi-arrow-right"></i></a>
                                    <?php } ?>
