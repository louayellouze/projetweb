...
include ("../../Controller/publicationC.php");
 ...
 $result = $pubC->afficher_publications();
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
                        <a class="nav-link " href="AfficherRating.php">
                            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>shop </title>
                                    <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center" >
                   ...
                   <input type="text" class="form-control" placeholder="Search ... " id="SearchByEmail" onkeyup="chercher()" >
                </div>
              </div>
                          ...
                          foreach($result as $row) {
                               echo "<tr>" .
                                 ...
                                 "<td>" . $row["titre"] . "</td>" .
                                  "<td>" . $row["contenu"] . "</td>" .
                                  "<td>" . " <form method='post'>
                                  <button class='btn btn-danger w-100 py-3'  name='delete'>Delete</button> 
  ...
  <script >
    /*function chercher (){
      ...
      console.log("dfkpdqskfpkdsq");
      const input = document.getElementById('SearchByEmail');
      
      input.addEventListener("change", (event) => {
        const val = document.getElementById('SearchByEmail').value;
        if (val != "") {
        $result = $user -> RechercheAdmin(val);
      }
    else {
