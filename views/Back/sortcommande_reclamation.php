    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="../pages/dashboard.html">
                <img src="img/logo.png" class="navbar-brand-img h-100 w-15" alt="...">
                <span class="ms-1 font-weight-bold"> NATURIMAL ADMIN SPACE</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="AfficherBotaniqueAd.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>shop </title>
                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Botanique</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="../Back/afficher.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Animalerie</span>
                    </a>
                <li class="nav-item">
                    <a class="nav-link  " href="AfficherVeterinaire.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>shop </title>
                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Les Veterinaires</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="AfficherAnimal.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>shop </title>
                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Les Animeaux</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="AfficherHeb.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>shop </title>
                                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="commande_reclamation.php">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h2 class="font-weight-bolder mb-0">Gestion Commandes-Reclamations</h2>
                </nav>
                <br>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                ...
                                <div class="container my-2">
                                    ...
                                    <span><a onclick="window.print();" class="btn btn-primary" style="margin-top: 10px; border-radius: 6px; background-color: white;color: black; border: 2px solid #4CAF50;" id="Trier">Print</a></span>
                                    <span><a href="sortcommande_reclamation.php" class="btn btn-primary" style="margin-top: 10px; border-radius: 6px; background-color: white;color: black; border: 2px solid #4CAF50;" id="Trier">Trier</a></span>
                                    <input class="col-10" type="text" name="AfficherClasse" onkeyup="myFunction1()" placeholder="rechercher Client" id="myInput1" style="height: 46px;border-radius: 6px; background-color: white;color: black; border: 2px solid #4CAF50;">
                                ...
                                <table class="table align-items-center mb-0" id="mytable1">
                                    ...
                                    <tbody>
                                        ...
                                        $commandes = $commande->afficher_commande_sort();
                                        foreach ($commandes as $c) :
                                            $image = $commande->return_image($c['typeproduit'], $c['idproduit']);
                                            $check_danger = $commande->check_commande_in_reclamation($c['id_commande'],$c['idproduit'],$c['typeproduit']);
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <!-- C:/xampp/htdocs/vegefoods-Copy2/images/product-1.jpg -->
                                                            <?php
                                                            if ($c['typeproduit'] == "jardinage") {
                                                                foreach ($image as $im) : ?>
                                                                    <img src="../Front/images/<?= $im['ImageArticle']; ?>" class="avatar avatar-sm me-3">
                                                                <?php endforeach;
                                                            } else if ($c['typeproduit'] == "access") {
                                                                foreach ($image as $im) : ?>
                                                                    <img src="../Front/images/<?= $im['image']; ?>" class="avatar avatar-sm me-3">
                                                                <?php endforeach;
                                                            } else if ($c['typeproduit'] == "aliment") {
                                                                foreach ($image as $im) : ?>
                                                                    <img src="../Front/images/<?= $im['image']; ?>" class="avatar avatar-sm me-3">
                                                            <?php endforeach;
                                                            }
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?= $c['adresse']; ?></p>
                                                    <!-- <p class="text-xs text-secondary mb-0">Organization</p> -->
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                <?php if (empty($check_danger)){ ?>
                                                    <span class="badge badge-sm bg-gradient-success"><?= $c['total']; ?></span>
                                                    <?php }else
                                                    { ?>
                                                        <span class="badge badge-sm bg-gradient-danger"><?= $c['total']; ?></span>
                                                    <?php } ?>

                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"><?= $c['nomproduit']; ?></span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"><?= $c['qtproduit']; ?></span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"><?= $c['typeproduit']; ?></span>
                                                </td>
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                ...
                                <div class="container my-2">
                                    <span><a onclick="window.print();" class="btn btn-primary" style="margin-top: 10px; border-radius: 6px; background-color: white;color: black; border: 2px solid #4CAF50;" id="Trier">Print</a></span>
                                    <span><a href="sortcommande_reclamation.php" class="btn btn-primary" style="margin-top: 10px; border-radius: 6px; background-color: white;color: black; border: 2px solid #4CAF50;" id="Trier">Trier</a></span>
                                    <input class="col-10" type="text" name="AfficherClasse" onkeyup="myFunction2()" placeholder="rechercher Client" id="myInput2" style="height: 46px;border-radius: 6px; background-color: white;color: black; border: 2px solid #4CAF50;">
                                </div>
                                ...
                                <table class="table align-items-center mb-0" id="mytable2">
                                    ...
                                    <tbody>
                                        ...
                                        $rec = $reclamation->afficher_reclamation_sort();
                                        foreach ($rec as $r) :
                                            $adresse = $reclamation->get_adresse_commande($r['id_commande'], $r['idproduit']);
                                            $image = $reclamation->get_image_commande($r['idproduit'], $r['typeproduit']);
                                            $nom = $reclamation->get_nom_produit_reclamation($r['id_commande'], $r['idproduit']);
                                        ?>
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div>
                                                            <!-- C:/xampp/htdocs/vegefoods-Copy2/images/product-1.jpg -->
                                                            <img src="../Front/images/<?= $image; ?>" class="avatar avatar-sm me-3">
                                                        </div>
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm"><?= $r['nom'] . " " . $r['prenom']; ?></h6>
                                                            <p class="text-xs text-secondary mb-0"><?= $r['email']; ?></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><?= $adresse; ?></p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"><?= $nom; ?></span>
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span class="text-secondary text-xs font-weight-bold"><?= $r['typeproduit']; ?></span>
                                                </td>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-left">
                                ...
                                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Naturimal</a>
                                for a better web.
                            </div>
                        </div>
                    </div>
